...
@Getter
@Setter
public class UserUserRequestParam {
  ...
  @StringType(message = "passwordを文字列型で入力してください。")
  @Length(min = 10, max = 100, message = "passwordを10文字以上100文字以下で入力してください。")
  ...
  private UserCreditCardRequestParam creditCard;
}
